    ...
    <div style={{ background: "#f0eee4" }}>
      ...
      >
        ...
        <div style={{ alignSelf: "flex-end" }}>
          <Image src="/assets/8.avif" alt="banner" width={1000} height={1000} />
        </div>
          ...
          <div className="container mx-auto max-w-7xl pt-16 px-6 flex-grow -mt-72 z-20">
            ...
            <div style={{ marginTop: 20 }}>
              ...
              <p style={{ marginTop: 20, width: 600, fontSize: 12 }}>
                Make a statement with our range of crystal bracelets. From our
                iconic Tennis Deluxe design to adjustable styles for a perfect
                fit, each spellbinding piece can be worn solo or stacked –
                anything goes.
              </p>
            </div>
          </div>
