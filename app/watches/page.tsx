    ...
    <div style={{ background: "#f0eee4" }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            <Link href="/accessories">
              <div className="hover:underline">Accessories</div>
            </Link>
            <Link href="/necklaces">
        ...
        <div style={{ alignSelf: "flex-end" }}>
          <Image src="/assets/5.avif" alt="banner" width={1000} height={1000} />
        </div>
          ...
          <div className="container mx-auto max-w-7xl pt-16 px-6 flex-grow -mt-72 z-20">
            ...
            <div style={{ marginTop: 20 }}>
              ...
              <p style={{ marginTop: 20, width: 600, fontSize: 12 }}>
                Our watches range is both elegant and versatile. Think metal
                watches, bestelling black and red designs, and jewelry-inspired
                styles – all elevated with dazzling crystals to stand the test
                of time.
              </p>
            </div>
          </div>
